        ...
        <div id="_desktop_language_selector" class="_desktop_language_selector">
            <div class="language-selector-wrapper">
                <div class="language-selector dropdown js-dropdown">
                    <span class="expand-more" data-toggle="dropdown">{l s=' Language: ' d='Shop.Theme.Actions'}<span class="main_color">{$current_language.name_simple|escape:'html':'UTF-8'}</span></span>
