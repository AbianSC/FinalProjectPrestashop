				...
				{*if isset($page_name) && $page_name != 'index'}
					<div class="functional-buttons clearfix">
						...
						{if isset($comparator_max_item) && $comparator_max_item}
							<div class="compare">
								<a class="add_to_compare" href="{$product.link|escape:'html':'UTF-8'}" data-id-product="{$product.id_product|escape:'html':'UTF-8'}">{l s='Add to Compare' d='Shop.Theme.Actions'}</a>
							</div>
						{/if}
					</div>
				{/if*}
