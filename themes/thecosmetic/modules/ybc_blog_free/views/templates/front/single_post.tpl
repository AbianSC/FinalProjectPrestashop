...
<html lang="{$language.iso_code|escape:'html':'UTF-8'}">
  ...
  <body id="{$page.page_name|escape:'html':'UTF-8'}" class="{$page.body_classes|classnames} {if isset($YBC_TC_CLASSES)}{$YBC_TC_CLASSES|escape:'html':'UTF-8'}{/if}{if isset($tc_config.YBC_TC_LISTING_REVIEW) && $tc_config.YBC_TC_LISTING_REVIEW != 1} hidden_review{/if}">
                ...
                <div class="ybc_blog_free_layout_{$blog_layout|escape:'html':'UTF-8'} ybc-blog-wrapper-detail" itemscope itemType="http://schema.org/BlogPosting">
                    ...
                    {if $blog_post}
                            ...
                            <div class="ybc-blog-wrapper-comment">          
                                {if $allowComments}
                                    <div class="ybc_comment_form_blog">
                                        ...
                                        <div class="ybc-blog-form-comment nhq">                   
                        ...
                        {if $blog_post.related_posts}
                            <div class="{if $blog_post.related_posts|count lte 3}no_action{/if} ybc-blog-related-posts custom_nav_icon ybc_blog_free_related_posts_type_{if $blog_related_posts_type}{$blog_related_posts_type|escape:'html':'UTF-8'}{else}default{/if}">
