                        ...
                        <div class="tab_title">
                            <div class="wraper_title_section">
                                ...
                                <span class="sub_title_section">
                                    {if isset($tc_config.YBC_TC_SUBTITLE_SECTION_TABHOME) && $tc_config.YBC_TC_SUBTITLE_SECTION_TABHOME}
                                        {$tc_config.YBC_TC_SUBTITLE_SECTION_TABHOME|escape:'html':'UTF-8'}
                                    {/if}
                                </span>
