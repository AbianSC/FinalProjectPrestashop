...
<div class="box">
  <header>
    ...
    <p>{l s='If you wish to return one or more products, please mark the corresponding boxes and provide an explanation for the return. When complete, click the button below.' d='Shop.Theme.Catalog'}</p>
  </header>
