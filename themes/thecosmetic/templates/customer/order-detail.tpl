...
{block name='page_content'}
  ...
  {block name='order_infos'}
    <div id="order-infos">
      ...
      <div class="box">
          <ul>
            <li><strong>{l s='Carrier' d='Shop.Theme.Actions'}</strong> {$order.carrier.name|escape:'html':'UTF-8'}</li>
            <li><strong>{l s='Payment method' d='Shop.Theme.Actions'}</strong> {$order.details.payment|escape:'html':'UTF-8'}</li>
    ...
    <div class="addresses">
      {if $order.addresses.delivery}
        <div class="col-lg-6 col-md-6 col-sm-6">
          <article id="delivery-address" class="box">
            <h4>{l s='Delivery address %alias%' d='Shop.Theme.Actions' sprintf=['%alias%' => $order.addresses.delivery.alias]}</h4>
      ...
      <div class="col-lg-6 col-md-6 col-sm-6">
        <article id="invoice-address" class="box">
          <h4>{l s='Invoice address %alias%' d='Shop.Theme.Actions' sprintf=['%alias%' => $order.addresses.invoice.alias]}</h4>
